...
<body class="w3-content">
    ...
    <p class="c0">&nbsp;</p>
    <p class="c0"><span class="c1">Functionaris gegevensbescherming</span>
    </p>
    <p class="c6"><span class="c4">De organisator heeft geen vaste
            &ldquo;functionaris gegevensbescherming&rdquo;. Deze wordt binnen de
            vereniging door het bestuur benoemd. Gezien de aard, doelstelling en
            omvang van de vereniging kan de verwerking van persoonsgegevens bij
            de organisator als laag complex gezien worden.</span>
    </p>
    <p class="c0">&nbsp;</p>
    <p class="c0"><span class="c1">Persoonsgegevens die wij verwerken</span>
    </p>
    <ol class="c8 lst-kix_list_1-1 start" start="1">
        <li class="c2"><span class="c1">Welke persoonsgegevens de organisator
                verwerkt &nbsp;</span>
        </li>
    </ol>
    <p class="c6 c7"><span class="c4">De organisator verwerkt jouw
            persoonsgegevens digitaal voor haar leden- en financi&euml;le
            administratie. Daarnaast heeft de organisator ook een papieren
            administratie. </span>
    </p>
    <p class="c3"><span class="c4">De gegevens zijn door jou zelf op vrijwillige
            basis aan de organisator verstrekt.</span>
    </p>
    <p class="c3"><span class="c4">Hieronder vind je een overzicht van de
            persoonsgegevens die wij verwerken:</span>
    </p>
    <ul class="c8 lst-kix_list_5-0 start">
        <li class="c2"><span class="c4">Voor- en achternaam </span>
        </li>
        <li class="c2"><span class="c4">Gegevens woonadres</span>
        </li>
        <li class="c2"><span class="c4">Telefoonnummer(s)</span>
        </li>
        <li class="c2"><span class="c4">E-mailadres</span>
        </li>
        <li class="c2"><span class="c4">Bankrekeningnummer</span>
        </li>
    </ul>
    <p class="c0"><span class="c4"></span>
    </p>
    ...
    <p class="c6 c7"><span class="c4">Indien je voor de plaatsing van
            bovenstaande gegevens op de adressenlijst geen toestemming geeft,
            dan kun je dat kenbaar maken in de privacyverklaring ter afsluiting
            van dit document.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6 c7"><span>2.</span><span class="c1">3 &nbsp;Gevoelige
            persoonsgegevens</span>
    </p>
    <p class="c6 c7"><span class="c4">de organisator verwerkt g&eacute;&eacute;n
            gevoelige persoonsgegevens zoals o.a. BSN, medische gegevens, ras,
            afkomst, religie, politieke- en seksuele voorkeuren. </span>
    </p>
    <p class="c3"><span class="c4">Lichamelijke ongemakken van leden en/of
            medicijngebruik, waar tijdens de optredens en </span>
    </p>
    <p class="c3"><span class="c4">uitvoeringen rekening mee gehouden moet
            worden zullen alleen bij het bestuur bekend zijn </span>
    </p>
    <p class="c6 c7"><span class="c4">en als vertrouwelijk worden behandeld.
            Deze gegevens zullen we alleen indien het lid dit zelf wenst bij het
            secretariaat bewaren.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6 c7"><span>2.4 &nbsp;</span><span class="c5">Doelstelling
            verwerken persoonsgegevens</span>
    </p>
    <p class="c3"><span class="c4">Met welk doel en op basis van welke grondslag
            wij persoonsgegevens verwerken.</span>
    </p>
    <p class="c3"><span class="c4">de organisator verwerkt jouw persoonsgegevens
            voor de volgende doelen:</span>
    </p>
    <ul class="c8 lst-kix_list_7-0 start">
        <li class="c2"><span class="c4">Het afhandelen van de betaling van jouw
                contributie</span>
        </li>
        <li class="c2"><span class="c4">Het verzenden van onze
                nieuwsbrief</span>
        </li>
        <li class="c2"><span class="c4">Eventuele verdere communicatiedoeleinden
                uitsluitend binnen- en in het belang van de vereniging</span>
        </li>
        <li class="c2"><span class="c4">Het zichtbaar zijn voor medeleden
                bijvoorbeeld in verband met groepsrepetities, carpooling
                etc.</span>
        </li>
    </ul>
    <p class="c3"><span class="c4">De betreffende gegevens staan op de
            afgeschermde pagina van onze website.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <ol class="c8 lst-kix_list_1-0" start="3">
        <li class="c6 c10"><span class="c1">Website en social media</span>
        </li>
    </ol>
    <p class="c6 c7"><span class="c1">3.1 Verzamelen gegevens website</span>
    </p>
    <p class="c6 c7"><span class="c4">De website van de organisator heeft niet
            de intentie gegevens te verzamelen over websitebezoekers.</span>
    </p>
    <p class="c3"><span class="c4">de organisator gebruikt geen cookies of
            vergelijkbare technieken.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6 c7"><span class="c5">3.2</span><span>&nbsp; </span><span
            class="c5">Foto&rsquo;s en filmmateriaal publieke optredens</span>
    </p>
    <p class="c3"><span class="c4">Als er tijdens optredens foto&acute;s, video-
            en/of CD-opnames gemaakt worden kunnen de leden zich </span>
    </p>
    <p class="c3"><span class="c4">niet beroepen op hun portretrecht indien deze
            gepubliceerd worden als promotie.</span>
    </p>
    ...
    <p class="c6 c7"><span class="c1">3.3 &nbsp;Foto&rsquo;s besloten
            optredens</span>
    </p>
    <p class="c6 c7"><span class="c4">Foto&rsquo;s en video-opnames van besloten
            optredens en besloten verenigingsavonden worden in beginsel
            uitsluitend geplaats op het afgeschermde gedeelte van de website.
            Alleen indien geen van de leden heeft aangegeven daar bezwaar tegen
            te hebben kunnen deze foto&rsquo;s en video-opnames op het openbare
            gedeelte van de website en/of social mediapagina&rsquo;s van de
            organisator worden geplaatst voor promotiedoeleinden.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6"><span class="c1">4 &nbsp;Bewaartermijn </span>
    </p>
    <p class="c6"><span class="c4">de organisator bewaart de bij ons bekende
            persoonsgegevens van jou niet langer dan strikt nodig is. </span>
    </p>
    <p class="c6"><span class="c4">De bewaartermijn voor jouw persoonsgegevens
            is gedurende jouw lidmaatschap tot maximaal een jaar na het
    ...
    <p class="c6"><span class="c1">5 &nbsp;Delen van persoonsgegevens met
            derden</span>
    </p>
    <p class="c6"><span class="c4">de organisator deelt jouw gegevens niet met-
            of verkoopt deze niet aan derden. de organisator</span>
    </p>
    <p class="c6"><span class="c4">blijft verantwoordelijk voor de verwerking
            van jouw persoonlijke gegevens.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6"><span class="c1">6 &nbsp;Gegevens inzien, aanpassen of (laten)
            verwijderen </span>
    </p>
    <p class="c6"><span class="c4">Je hebt het recht om je persoonsgegevens in
            te zien, te corrigeren of te (laten) verwijderen. Daarnaast heb je
            het recht om je eventuele toestemming voor de (niet noodzakelijke)
            gegevensverwerking in te trekken of bezwaar te maken tegen de wijze
            van verwerking van jouw persoonsgegevens door de organisator.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6"><span class="c1">7 &nbsp;Verzoek tot inzage, correctie,
            verwijdering</span>
    </p>
    <p class="c6"><span class="c4">Je kunt een verzoek tot inzage, correctie,
            verwijdering of een verzoek tot intrekking van je toestemming of
            bezwaar op de verwerking van jouw persoonsgegevens schriftelijk
            indienen bij het &nbsp;bestuur van de vereniging. Om er zeker van te
            zijn dat het verzoek tot inzage door jou is gedaan, vragen wij jou
            een kopie van je identiteitsbewijs met het verzoek deze mee te
            sturen. Maak in deze kopie je pasfoto, de strook met nummers
            ...
            mogelijk, maar binnen vier weken, op jouw verzoek.</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6"><span class="c1">8 &nbsp;Klachten</span>
    </p>
    <p class="c6"><span class="c4">de organisator wijst je er tevens op dat je
            de mogelijkheid hebt om een klacht in te dienen bij de </span>
    </p>
    <p class="c6"><span class="c4">nationale toezichthouder, de Autoriteit
            Persoonsgegevens. Dat kan via de volgende link: </span>
    </p>
    <p class="c6"><span
            class="c4">https://autoriteitpersoonsgegevens.nl/nl/contact-met-de-autoriteit-persoonsgegevens/tip-ons</span>
    </p>
    <p class="c0"><span class="c4"></span>
    </p>
    <p class="c6"><span class="c1">9 &nbsp;Hoe wij persoonsgegevens
            beveiligen</span>
    </p>
    <p class="c6"><span class="c4">de organisator neemt de bescherming van jouw
