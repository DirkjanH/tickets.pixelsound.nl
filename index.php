        ...
        <form name="bestelformulier" id="bestelformulier" method="POST"
            ...
            <div class="w3-container w3-margin-top">
                <div class="w3-row-padding">
                    <div class="w3-third">
                        ...
                        <input name="aantal_vol" type="text"
                    ...
                    <div class="w3-third"
                        <?php if (!(isset($c['prijs_kind']) and $c['prijs_kind'] > 0)) echo 'style="display: none;"'; ?>>
                        <div
            ...
            <div class="w3-panel onzichtbaar">
                <label class="w3-label"><?php echo $txt['huisgenoten']; ?>
                    <input class="w3-input w3-border onzichtbaar"
                        name="huisgenoten" type="text"
                        value="<?php
                                if (isset($_POST['huisgenoten'])) echo stripslashes($_POST['huisgenoten']); ?>"
                        size="50">
                </label>
            </div>
            <div
                class="<?php if ($allesuitverkocht) echo 'onzichtbaar'; ?> w3-label w3-panel panelkleur">
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-third w3-panel w3-leftbar w3-border-green">
                        <p>
                            ...
                            <label
                                class="w3-label w3-validate"><?php echo $txt['anders']; ?>
                                <input class="w3-input w3-border"
                                    name="opmerkingen" type="text"
                                    value="<?php
                                            if (isset($_POST['opmerkingen'])) echo stripslashes($_POST['opmerkingen']); ?>"
                                    size="20">
                            </label>
                        </p>
                    </div>
            ...
            <div class="w3-container">
                <input class="w3-btn w3-green"
                    <?php if (isset($c['uitverkocht']) and ($c['uitverkocht'] == 1)) echo 'DISABLED '; ?>name="submit"
