  ...
  <div id="main">
    <form id="vinden" method="post" action="<?php echo $editFormAction; ?>">
      <table width="100%" border="0" align="center" cellpadding="5"
        cellspacing="0">
        <tr>
          <td><label><br> Zoekterm: <input name="zoeknaam" type="text"
                id="zoeknaam"
        ...
        </tr> <?php if (isset($zoek_tabel)) { ?> <tr>
            <td valign="top">
              <p><?php echo mysqli_num_rows($zoek_tabel); ?>
                resultaten. Klik een item aan: </p>
              <div id="navcontainer">
                <ul id="navlist"> <?php while ($zoek = mysqli_fetch_assoc($zoek_tabel)) {
                                    $datum = strftime("%a %e %B %Y", strtotime($zoek['datum']));
                                    $z = $zoek['concerttitel']; ?> <li id="active"><a
                        href="javascript:ToonId(<?php if (isset($zoek)) echo $zoek['concertId']; ?>)"
                        ;>
                        <?php
...
</html> >>>>>>> ef83e72eecde1df5e74048f39a4e89ef042026c5