...
<body>
    <div id="nav"
        ...
        <form id="vinden" method="post" action="<?php echo $editFormAction; ?>">
            <div class="w3-panel">
                <label>Zoekterm: <br><input name="zoeknaam" type="text"
                        id="zoeknaam"
                        value="<?php echo $_SESSION['zoeknaam']; ?>"
                        size="5"></label>
    ...
    <div id="main" class="w3-main w3-white w3-container w3-padding">
        <form name="concert" method="POST" id="concert"
            action="<?php echo $editFormAction; ?>">
            <table width="100%" align="left">
                <tr valign="baseline">
                    <td width="10%" align="right" nowrap>concertId:</td>
                    <td colspan="2"><input type="text" name="concertId"
                    ...
                    <td width="70%"><input type="text" name="prijs_vol"
                            value="<?php echo $concert['prijs_vol']; ?>"
                            size="40" />
                        <br />
                    </td>
                </tr>
                <tr valign="baseline">
                    ...
                    <td><input type="text" name="concerttitel"
                            value="<?php echo htmlspecialchars($concert['concerttitel']); ?>"
                            size="32" />
                    </td>
                    <td width="3%" align="right" nowrap="nowrap">Online: <input
                            type="checkbox" name="online" value="1"
                            <?php if ($concert['online'] == 1) echo 'checked'; ?> />
                    </td>
                    <td width="100" align="right" nowrap>Prijs red.:</td>
                    <td width="70%"><input type="text" name="prijs_red"
                            value="<?php echo $concert['prijs_red']; ?>"
                            size="10" /> ; korting voor <input type="text"
                            name="txt_red"
                            value="<?php echo $concert['txt_red']; ?>"
                            size="40" />
                    </td>
                </tr>
                <tr valign="baseline">
                    <td width="10%" align="right" nowrap>Datum (yyyy-mm-dd):
                    </td>
                    <td width="300" colspan="2"><input type="text" name="datum"
                            value="<?php echo $concert['datum']; ?>"
                            size="40" />
                    </td>
                    <td align="right" nowrap="nowrap">Prijs kind:</td>
                    <td width="70%"><input name="prijs_kind" type="text"
                            id="prijs_kind"
                            value="<?php echo $concert['prijs_kind']; ?>"
                            size="10" /> ; korting voor <input type="text"
                            name="txt_kind"
                            value="<?php echo $concert['txt_kind']; ?>"
                            size="40" />
                    </td>
                </tr>
                <tr valign="baseline">
                    <td width="10%" align="right" nowrap>Tijd (hh:mm):</td>
                    <td width="300" colspan="2"><input type="text" name="tijd"
                            value="<?php echo $concert['tijd']; ?>" size="40" />
                    </td>
                ...
                <tr valign="baseline">
                    ...
                    <td width="300" colspan="2"><input type="text" name="plaats"
                            value="<?php echo $concert['plaats']; ?>"
                            size="40" />
                    </td>
                    <td width="100" align="right" nowrap>Uitverkocht:</td>
                    <td width="70%"><input name="uitverkocht" type="checkbox"
                            id="uitverkocht" value="1"
                            <?php if ($concert['uitverkocht'] == 1) echo 'checked'; ?>>
                    </td>
                </tr>
                <tr valign="baseline">
                    <td width="10%" align="right" valign="top" nowrap>Publieke
                        details:</td>
                    <td colspan="2"><textarea name="details" cols="40"
                            rows="3"><?php echo $concert['details']; ?></textarea>
                    </td>
                    <td width="100" align="right" valign="top">Interne
                        opmerking:&nbsp;</td>
                    <td width="70%" align="left" valign="top"><textarea
                            name="opmerking_intern" cols="40" rows="3"
                            id="opmerking_intern"><?php echo $concert['opmerking_intern']; ?>&nbsp;</textarea>
                    </td>
                </tr>
                <tr valign="baseline">
                    <td width="10%" align="right" nowrap>&nbsp;</td>
                    <td colspan="2"><input name="Toevoegen" type="submit"
                            id="Toevoegen" value="Toevoegen" />
                        <input name="Wijzigen" type="submit" id="Wijzigen"
                            value="Wijzigen" />
                        <input name="Wissen" type="submit" id="Wissen"
                            value="Wissen" />
                    </td>
                    <td width="100" align="right"><input name="leegmaken"
                            type="submit" id="leegmaken" value="Leegmaken" />
                    </td>
                    <td width="70%">&nbsp;</td>
                </tr>
            </table>
